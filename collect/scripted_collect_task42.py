...
Task 42: pick up the black bowl on top of the wooden cabinet and place it on the plate.
...
EXPECTED_MAX_STEPS = 155  # Tightened after video review

def main():
    parser = argparse.ArgumentParser(
        description="Scripted waypoint demo collection (Task 42: black bowl on cabinet → plate)")
    ...
    print("=" * 60)
    print("Scripted Waypoint Demo Collection (Task 42)")
    print("=" * 60)
