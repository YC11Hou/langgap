...
Task 41: pick up the black bowl on the right of the plate and place it on the plate.
...
EXPECTED_MAX_STEPS = 115  # Calibrated: max=109, ceil/5×5+5=115

def main():
    parser = argparse.ArgumentParser(
        description="Scripted waypoint demo collection (Task 41: black bowl right of plate → plate)")
    ...
    print("=" * 60)
    print("Scripted Waypoint Demo Collection (Task 41)")
    print("=" * 60)
