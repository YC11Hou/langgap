...
Task 63: pick up the tomato sauce and place it in the basket.
...
Target: basket contain_region. Scene 2.
"""
...
EXPECTED_MAX_STEPS = 135  # Calibrated: max=129, ceil/5×5+5=135
